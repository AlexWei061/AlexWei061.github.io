...
date: 2021-12-11
tags: ["Math"]
summary: "我们先来举个例子，算一算 \\sqrt{87} 。首先我们知道 81 = 9^2 ，然后 87 - 81 = 6 ，然后用 9 + \\frac{6}{9 \\times 2} = 9\\frac 13 ，这个数约等于 9.3 。所以 \\sqrt{87} 也就约等于 9.3 了。我们用计算器计算一下看我们算的准不准："
math: true
---
{% raw %}
# 手撕根号
...
![在这里插入图片描述](/assets/images/blog/shousi1.png)
...
![在这里插入图片描述](/assets/images/blog/shousi2.png)
