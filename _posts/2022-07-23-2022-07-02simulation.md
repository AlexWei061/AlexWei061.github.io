...
layout: post
title: "T1 counting"
archive_title: "2022.07.02Simulation"
section: "OI"
section_slug: "oi"
...
summary: "小清新 T1 。个一个数列，没有修改，每次询问问大于等于 x 的数的个数。直接每次询问 lower\\ bound() 就搞定了。"
math: true
---
{% raw %}
## T1 counting

&emsp; 小清新 $T1$ 。个一个数列，没有修改，每次询问问大于等于 $x$ 的数的个数。直接每次询问 $lower\_bound()$ 就搞定了。
