...
![](/assets/images/blog/diameterTree.png)
...
![](/assets/images/blog/dismeterTree2.png)
...
&emsp; 我们需要俩数组，一个 $f\_1[MAXN]$，一个$f\_2[MAXN]$。分别表示在以 $i$ 节点为根的子树中，$i$ 到叶节点的距离的最大值和次大值。然后就是显而易见玄学的动归方程了（其中$w[i][j]$ 表示 $i$ 到 $j$ 的边权）：
