...
layout: post
title: "T1 set"
archive_title: "2021.10.30Simulation"
section: "OI"
section_slug: "oi"
...
summary: "选取的 k 个点在树上形成一个连通子树，然后我们考虑树形 DP。我们知道所选的路径一定是从树的直径上往下走，然后遇到分叉就走过去，然后再回到直径上。所以直径上的边权只算一次，其他的边权算两次。"
math: true
---
{% raw %}
## T1 set
...
&emsp; 设 $f\_{i, j, k}$ 表示起点和终点有 k 个在以 i 为根的子树中，且选了 j 个点时的最小代价。那么我们有：
