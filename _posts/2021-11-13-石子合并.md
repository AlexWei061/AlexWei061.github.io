...
date: 2021-11-13
tags: ["DP", "rangeDp"]
summary: "原题传送门：luogu P5569 SDOI2008"
math: true
---
{% raw %}
# 石子合并
...
&emsp; 其中：$\forall l \in [1, N]，F[l, l] = 0$，我们要求的答案就是 $F[1, N]$。然后对于每次查询 $\sum\limits\_{i=l}^r A\_i$，我们对 $A$ 数组做一个前缀和就好了。
```cpp
#include<bits/stdc++.h>
using namespace std;
#define MAXN 4040
