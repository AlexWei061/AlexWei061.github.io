...
layout: post
title: "T1 loopers"
archive_title: "2021.10.18Simulation"
section: "OI"
section_slug: "oi"
...
&emsp; 题目说了，下一次走到一个点 i 的概率为$a\_i / \sum\_{没选过的点j}a\_j$，所以我们得到在第一个点之前选到第 i 个点的概率为：$\frac{a\_i}{a\_1+a\_i}$。再乘上这个节点的值 $a\_i$ 就是这个点的数学期望。然后我们把所有点的期望加起来就得到总的期望：
...
&emsp; 我们因为要对答案取模，所以要算出 1 ~ $a\_{max}$ 的所有逆元，所以我们用线性递推的方法。最后的时间复杂度是 $O(10^8 + n)$
