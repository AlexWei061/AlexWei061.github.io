...
summary: "我们已经见过了 LeNet 和 AlexNet ，一个是 3 层，一个是 7 层，那么如果我们想实现一些更多层的神经网络要怎么办呢，还是手动开每一层吗？"
math: true
---
{% raw %}
# VGG
...
![在这里插入图片描述](/assets/images/machine-learning/SupervisedLearning/Nets/pic/vgg.png)
